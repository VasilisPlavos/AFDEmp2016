...
public class testLib {
	...
	public static void main(String[] args) {
		...
		c = input.nextLine();
		if (c.equals("1")){the_guy.findMeAvailableBooks();}
		if (c.equals("2")){
			System.out.println("Enter Book Title (eg. Book20): ");
			String book_title = input.nextLine();
			the_guy.findMeBook(book_title);
		}
		if (c.equals("3")){
			System.out.println("Enter Author Name (eg. Ruth): ");
			String specific_author = input.nextLine();
			the_guy.findMeBooksFromAuthor(specific_author);
		}
		if (c.equals("q")){
